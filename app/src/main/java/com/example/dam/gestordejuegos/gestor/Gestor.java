...
import com.example.dam.gestordejuegos.Ayudante;
 ...
 */
    ...
    public abstract class Gestor<T> {
        ...
        public int search(String tabla ,String condicion, String[] argumentos){
            String sql="SELECT * FROM "+ tabla + " WHERE " + condicion + " = "+argumentos;
            Cursor c = getCursor(tabla,null,condicion,argumentos,null,null,null);
